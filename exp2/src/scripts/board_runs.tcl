...
#   动作：打开 exp2.xpr（含固件 ROM 固化 define + board.xdc 全约束）
#         → launch synth_1 → launch impl_1(-to write_bitstream) → 出 .bit
#   bit 产物：vivado/exp2/exp2.runs/impl_1/soc_top.bit
...
puts "BIT: [file join $board vivado exp2 exp2.runs impl_1 soc_top.bit]"
exit
