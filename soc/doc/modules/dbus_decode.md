...
- **契约单源**：`../../pipeline/doc/modules/dbus_decode.md`（计组侧，含端口/地址分区/时序/验收全文）+ `../../pipeline/doc/isa.md` §4 + `../UART/doc/interface.md`。**本文件只登记交付与装配要点，不重复定义**；两者不一致以单源为准并先改契约。
